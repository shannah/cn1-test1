 ...
 * @author Shai Almog
 */
public class Cn1Test1Stub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Cn1 Test1";
    private static final String APP_NAME = "cn1-test1";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Cn1Test1Stub());
    }
